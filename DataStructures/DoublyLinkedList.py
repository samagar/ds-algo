# DataStructure
# Doubly Linked List
# Linked list node contains value and pointer to a previous and next node

'''
# Doubly Linked List
# Define node with Value, next and Previous. Define head and tail - assign node to it.
# Insert at begining, Middle and At end.
# Insert middle - Stop at element before location. Set temp = location (next of stop).
# Set Newnode.next = Location.next. Newnode.prev = location.newnode.next.previous = newNode. location.next = newNod
